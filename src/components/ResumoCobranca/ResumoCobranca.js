  ...
  return (
    <div className='container-resumo-cobranca'>
      <div className='container-dados-cobranca-1'>
        ...
        <p className='descricao-cobranca'>{cliente.descricaoCobranca || 'Pagamento referente a dívida educacional contraída para pagamento de curso de programação'}</p>
        <p className='valor-cobranca'>{cliente.valorCobranca || 'R$5.000,00'}</p>
      </div>
